...
@media (max-width: 1199px) {
  ...
  <!-- Favicons -->
<link href="img/k.bmp" rel="icon">  <link href="assets/img/apple-touch-icon.png" rel="apple-touch-icon">
...
<!--===============================================================================================-->
 ...
 <meta charset="utf-8">
  ...
  <body>
        ...
        <nav class="nav-menu">
        <ul>
 <li><a href="index.php"><i class="bx bx-home"></i> <span><<<--Back To Home</span></a></li>
        </ul>
      </nav><!-- .nav-menu -->
	  <br><br>
...
if(isset($_POST["submit"])){
 ...
 $db = mysqli_select_db($conn, 'hassaan') or die("databse error");
 //Selecting database
 ...
 <div class="alert alert-danger">
    <strong>Invalid!!!</strong> Email or Password   </div>
  </h3>
