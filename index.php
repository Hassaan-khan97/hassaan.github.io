    ...
    <div class="d-flex flex-column">
      ...
      <nav class="nav-menu">
        <ul>
          ...
          <li><a href="#images"><i class="bx bx-image"></i> <span>Photos</span></a></li>
<!--		  <li><a href="#comment"><i class="bx bx-comment"></i> <span>Comment for me</span></a></li>   -->
		  <li><a href="#about"><i class="bx bx-file"></i> <span>About</span></a></li>
          <li><a href="#skills"><i class="bx bx-navigation"></i> <span>Skills</span></a></li>
          <li><a href="#contact"><i class="bx bx-phone"></i> Contact</a></li>
  ...
  <section id="hero" class="d-flex flex-column justify-content-center align-items-center">
    <div class="hero-container" data-aos="fade-in">
      <h1>Muhammad Hassaan Khan</h1>
      <p>I'm <span class="typed" data-typed-items="Web Designer,Web Developer, Freelancer, Computer Expert"></span></p>
    </div>
</section>
  <!-- ======= End Hero Section ======= -->
<main id="main">
            ...
            <form action="index.php" method="post" role="form" class="php-email-form">
              <div class="form-row">
                ...
                <div class="form-group col-md-6">
                  ...
                  <input type="number" class="form-control" name="phoneno" id="phoneno" data-rule="phoneo" data-msg="Please enter a valid phoneo" />
                  <div class="validate"></div>
                </div>
              </div>
...
if(isset($_POST["submit"])){
 ...
 $conn = mysqli_connect('ftpupload.net', 'epiz_25958472', 'hassaankhan') or die (mysqli_error()); // DB Connection
 $db = mysqli_select_db($conn, 'epiz_25958472_hassaan') or die("DB Error"); // Select DB from database
 //Selecting Database
 ...
 $sql = "INSERT INTO comments(name,phoneo,message) VALUES('$name','$phoneno','$message')";
 $result = mysqli_query($conn, $sql);
 //Result Message
 if($result){
 ?>
 <div class="alert alert-info">
    <strong>Thanks</strong> for your comment   </div>
 <?PHP
 }
 else{
 ?>
 <div class="alert alert-danger">
    <strong>Error</strong> plz try again   </div>
 <?PHP
 }
 }
 }
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-8 pt-4 pt-lg-0 content" data-aos="fade-left">
            <h3>Web Designer , Web Developer &amp; Computer Expert</h3>
            <br><br><br>
            <div class="row">
              <div class="col-lg-6">
                <ul>
                  <li><i class="icofont-rounded-right"></i> <strong>Birthday:</strong> 8 October</li>
                  
                  <li><i class="icofont-rounded-right"></i> <strong>Phone:</strong> 0305-3205130</li>
                <li><i class="icofont-rounded-right"></i> <strong>Email:</strong> mhassaank61@gmail.com</li>
              ...
              <div class="col-lg-6">
                <ul>
                  ...
                  <li><i class="icofont-rounded-right"></i> <strong>Degree:</strong> Web Developer</li>
                                    <li><i class="icofont-rounded-right"></i> <strong>location:</strong> Pakistan: Sindh, Sukkur</li>

                  <li><i class="icofont-rounded-right"></i> <strong>Freelance:</strong> Available</li>
                </ul>
              </div>
            </div>
            <p>My name is Muhammad Hassaan Khan.I am a web developer,web designer , freelancer and Computer Expert.I live in Pakistan.I love Pakistan.</p>
          </div>
        </div>
...
<div class="col-lg-8 pt-4 pt-lg-0 content" data-aos="fade-down">
...
<li> ALL TYPES SOFTWARE INSTALLATION   </li>
</div>
          ...
          <div class="col-lg-5 d-flex align-items-stretch">
            <div class="info">
              ...
              <div class="email">
                ...
                <h4>Email:</h4>
                <p>m.hassaankhan786@gmail.com</p>
              </div>
